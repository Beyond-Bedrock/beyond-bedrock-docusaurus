...
export default function ViewCounter({ slug, showLabel = true, incrementOnMount = true, className = '', style = {} }) {
  ...
  return (
    ...
    >
      ...
      {showLabel ? (
        <span>
          <AnimatedCount value={count} duration="2s" /> views
        </span>
      ) : (
        <AnimatedCount value={count} duration="2s" />
      )}
    </span>
  );
}